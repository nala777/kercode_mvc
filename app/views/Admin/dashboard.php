...
<main class="flex-1 h-screen overflow-y-scroll overflow-x-hidden">
    ...
    <section class="max-w-7xl mx-auto py-4 px-5">
        <div class="flex justify-between items-center border-b border-gray-300">
            <h1 class="text-2xl font-semibold pt-2 pb-6">Bienvenue <?= $_SESSION['firstname'] ?></h1>
        </div>
        <a href="indexAdmin.php?action=compte&id=<?= $_SESSION['id'] ?>"
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4 py-6">
            ...
            <div class="bg-white shadow rounded-sm flex justify-between items-center py-3.5 px-3.5">
                <div class="space-y-2">
                    <p class="text-xs text-gray-400 uppercase">Mails</p>
                    <div class="flex items-center space-x-2">
                        <h1 class="text-xl font-semibold"><?php $mail = $nbrMail->fetch() ?><?= $mail[0] ?></h1>
                        <a href="indexAdmin.php?action=showMails">Voir les mails</a>
                    </div>
                </div>
                <svg class="w-12 h-12 text-gray-300" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                    xmlns="http://www.w3.org/2000/svg">
